...
def training_function(script_args, training_args):    
    ...
    # main_process_first
    # - 이는 여러 프로세스 중 메인 프로세스를 지정함.
    # - 메인 프로세스가 특정 작업을 먼저 수행하도록 함
    # - 메인 프로세스가 작업을 마칠 때까지 다른 프로세스들을 대기 시킴
    # - 작업이 끝나면 모든 프로세스가 다시 동기화되어 다음 작업을 계속함
    ...
    model = AutoModelForCausalLM.from_pretrained(
        ...
        # training_args.gradient_checkpointing 이 값이 True 일 때만 Flash Attention2 기능 활성화
